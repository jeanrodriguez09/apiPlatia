...
try {
    ...
    // Validar que exista
    $sqlCheck = "SELECT id FROM itemHorarioExcepciones WHERE id = $idHorario AND estado = 1";
    ...
    // Eliminación lógica
    $sqlDelete = "UPDATE itemHorarioExcepciones
                  SET estado = 0,
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'Horario excepcion eliminado correctamente'
    ]);
