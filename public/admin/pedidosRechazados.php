<?php include 'cabecera.php'; ?>
      <title> Pedidos Rechazados || platIA || Administrador </title>
  ...
  <body class=" color-light ">
            ...
            <div class="card shadow mb-4">
              <div class="card-body">
                <div class="table-responsive">
                    <table id="tablaPedidosRechazados" class="table align-middle table-hover m-0">
                        <thead>
                          <tr>
    ...
    <script>
            $(document).ready(function () {
                const tabla = $('#tablaPedidosRechazados').DataTable({
                    ajax: {
                        url: 'subprocesos/listaPedidosRechazados.php', // Ruta a tu archivo PHP que retorna los datos
