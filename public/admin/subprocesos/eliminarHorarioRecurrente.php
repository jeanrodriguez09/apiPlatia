...
try {
    ...
    // Validar que exista
    $sqlCheck = "SELECT id FROM itemHorarioRecurrente WHERE id = $idHorario AND estado = 1";
    ...
    // Eliminación lógica
    $sqlDelete = "UPDATE itemHorarioRecurrente
                  SET estado = 0,
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'Horario recurrente eliminado correctamente'
    ]);
