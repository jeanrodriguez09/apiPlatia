...
$sql = "SELECT p.*, c.nombre AS nombreCliente, c.numero AS contactoCliente FROM pedidos p INNER JOIN clientes c ON c.id=p.idCliente WHERE p.estado = 1 ORDER BY p.fechaCreacion DESC";
